package com.ljkj.wellcover.utils.download;

import androidx.annotation.NonNull;

import com.ljkj.wellcover.utils.FileUtils;
...
public class DownloadManager {
    ...
    public String getDownloadFilePath() {
        if (isEmpty(mFileParentPath) || isEmpty(mFileName))
            return null;
